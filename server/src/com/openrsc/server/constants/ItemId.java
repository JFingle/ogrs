...
public enum ItemId {
	...
	OGRS_GOBLIN_TRINKET(1599),
	OGRS_CRACKED_SHAMAN_STAFF(1600),
	...
	// Magic items (art track from CODER_HANDOFF.md §3). Spellbooks +
	// wizard robe tiers (wizard / mystic blue / mystic dark / infinity)
	// + staves + skill capes + rune pouches + runecraft essence.
	// All sprites currently reuse upstream slots + tints; artist's
	// authored PNGs at art/items/magic/ waiting on packing pass.
	OGRS_MAGIC_SPELLBOOK_STANDARD(1642),
	OGRS_MAGIC_SPELLBOOK_ANCIENT(1643),
	OGRS_MAGIC_SPELLBOOK_YAHWIST(1644),
	OGRS_MAGIC_WIZARD_HAT(1645),
	OGRS_MAGIC_WIZARD_TOP(1646),
	OGRS_MAGIC_WIZARD_BOTTOM(1647),
	OGRS_MAGIC_MYSTIC_BLUE_HAT(1648),
	OGRS_MAGIC_MYSTIC_BLUE_TOP(1649),
	OGRS_MAGIC_MYSTIC_BLUE_BOTTOM(1650),
	OGRS_MAGIC_MYSTIC_DARK_HAT(1651),
	OGRS_MAGIC_MYSTIC_DARK_TOP(1652),
	OGRS_MAGIC_MYSTIC_DARK_BOTTOM(1653),
	OGRS_MAGIC_INFINITY_HAT(1654),
	OGRS_MAGIC_INFINITY_TOP(1655),
	OGRS_MAGIC_INFINITY_BOTTOM(1656),
	OGRS_MAGIC_STAFF_BASIC(1657),
	OGRS_MAGIC_STAFF_MAGIC(1658),
	OGRS_MAGIC_BATTLESTAFF(1659),
	OGRS_MAGIC_STAFF_OF_AIR(1660),
	OGRS_MAGIC_STAFF_OF_WATER(1661),
	OGRS_MAGIC_STAFF_OF_EARTH(1662),
	OGRS_MAGIC_STAFF_OF_FIRE(1663),
	OGRS_MAGIC_CAPE_MAGIC_SKILL(1664),
	OGRS_MAGIC_CAPE_MAGIC_MASTER(1665),
	OGRS_MAGIC_CAPE_RUNECRAFT_SKILL(1666),
	OGRS_MAGIC_POUCH_SMALL(1667),
	OGRS_MAGIC_POUCH_MEDIUM(1668),
	OGRS_MAGIC_POUCH_LARGE(1669),
	OGRS_MAGIC_ESSENCE_ROCK(1670),
	OGRS_MAGIC_ESSENCE_MINED(1671),
	OGRS_MAGIC_PURE_ESSENCE(1672),

	// Thief tools + drops (art track from CODER_HANDOFF.md §6).
	// Lockpicks, bags, keys, stolen jewelry, coins, documents,
	// specialty valuables. Sprite reuse + tints pending packing.
	OGRS_THIEF_LOCKPICK(1673),
	OGRS_THIEF_LOCKPICK_MASTER(1674),
	OGRS_THIEF_SAFECRACKING_TOOLS(1675),
	OGRS_THIEF_DISGUISE_KIT(1676),
	OGRS_THIEF_BAG_OF_HOLDING(1677),
	OGRS_THIEF_MONEY_PURSE(1678),
	OGRS_THIEF_SILVER_COIN_POUCH(1679),
	OGRS_THIEF_MYSTERY_BOX(1680),
	OGRS_THIEF_SNUFF_BOX(1681),
	OGRS_THIEF_IRON_KEY(1682),
	OGRS_THIEF_BRASS_KEY(1683),
	OGRS_THIEF_ORNATE_KEY(1684),
	OGRS_THIEF_STOLEN_RING(1685),
	OGRS_THIEF_STOLEN_NECKLACE(1686),
	OGRS_THIEF_SIGNET_RING(1687),
	OGRS_THIEF_LOCKET(1688),
	OGRS_THIEF_BROOCH(1689),
	OGRS_THIEF_COPPER_PILE(1690),
	OGRS_THIEF_DOUBLOONS(1691),
	OGRS_THIEF_GOLD_NUGGET(1692),
	OGRS_THIEF_CIPHER_SCROLL(1693),
